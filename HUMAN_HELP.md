...
The development goal is active. These items are parked, not reasons to stop independent offline work. Reply in the Codex task when you can help. Do not paste passwords, tokens, or private connection details into this public file.
